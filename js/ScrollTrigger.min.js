...
!(function (e, t) {
  ...
  function J(e, t) {
    return (
      ...
      ("string" == typeof e && !1 !== Te.config().nullTargetWarn ? console.warn("Element not found:", e) : null)
    );
  }
  function K(t, e) {
    var r = e.s,
                ...
                Te.delayedCall(0.08, function () {
                  if (300 < Ye() - xe && !t.defaultPrevented)
                    if (t.target.click) t.target.click();
                      ...
                      e.initMouseEvent("click", !0, !0, Se, 1, i.screenX, i.screenY, i.clientX, i.clientY, !1, !1, !1, !1, 0, null),
  ...
  function Jb() {
    (v && v.isPressed && !(v.startX > Je.clientWidth)) ||
      (qe.cache++, v ? (D = D || requestAnimationFrame(Z)) : Z(), st || U("scrollStart"), (st = at()));
  }
  function Kb() {
  ...
  function mc(e, t, r, n, i, o, a, s, l, c, u, f, d, p) {
    ...
    if ((p && ((s[p] = e || -0.001), e < 0 && (e = 0)), o)) {
      var T = e + r,
        C = o._isStart;
      (g = "scroll" + n.d2),
        X(o, T, n, (C && 20 < T) || (!C && (u ? Math.max(Je[g], We[g]) : o.parentNode[g]) <= T + 1)),
        u && ((l = wt(a)), u && (o.style[n.op.p] = l[n.op.p] - n.op.m - o._offset + xt));
    }
    return (
                ...
                if (ae && e && st) wb(ScrollTrigger, "scrollEnd", Ob);
                  ...
                  for (_e && Va(r) && ((h = He.getProperty(Y, he.p)), (v = He.getProperty(F, he.p))); 0 < P--; )
                    (c = Ct[P]).end || c.refresh(0, 1) || (Ke = Ce),
                      !(u = c.pin) || (u !== oe && u !== ae && u !== k) || c.isReverted || ((p = p || []).unshift(c), c.revert(!0, !0)),
                      c !== Ct[P] && (E--, P--);
                  for (
                    Ta(S) && (S = S(Ce)),
                      S = Ca(S, "start", Ce),
                      ...
                      ct(T) &&
                        ...
                        (~T.indexOf(" ")
                          ? (T = (ct(S) ? S.split(" ")[0] : "") + T)
                          : ((w = Cb(T.substr(2), b)),
                            (T = ct(S) ? S : (de ? He.utils.mapRange(0, de.duration(), de.scrollTrigger.start, de.scrollTrigger.end, R) : R) + w),
                            (C = oe))),
                      T = Ca(T, "end", Ce),
                      L =
                        Math.max(R, mc(T || (C ? "100% 0" : y), C, b, he, Ae() + w, I, F, Ce, m, Te, ye, y, de, Ce._endClamp && "_endClamp")) ||
                        -0.001,
                      w = 0,
                      P = E;
                    P--;
                    ...
                    (u = (c = Ct[P]).pin) &&
                      ...
                      ((u === oe && c.start - c._pinPush < R) || u === k) && isNaN(S) && (w += i * (1 - c.progress)),
                      u === ae && (_ += i));
                  if (
                    ((R += w),
                    (L += w),
                      ...
                      se
                        ? (((Z = [se + he.os2, N + _ + xt]).t = U),
                          (P = se === bt ? qb(ae, he) + N + _ : 0) &&
                            (Z.push(he.d, P + xt), "auto" !== U.style.flexBasis && (U.style.flexBasis = P + xt)),
                          Mt(Z),
                          k &&
                            Ct.forEach(function (e) {
                  ...
                  p &&
                    ...
                    (x || Oe !== Ce.progress || de || le || (O && !O._initted)) &&
                      (O && !ve && O.totalProgress(de && R < -0.001 && !Oe ? He.utils.normalize(R, L, 0) : Oe, !0),
              ...
              if (!de || r || e) {
                ...
                if (
                  ...
                  P &&
                    ...
                    !ot &&
                    st &&
                    (!d && R < u + ((u - B) / (at() - Ge)) * P ? (d = 1e-4) : 1 === d && L > u + ((u - B) / (at() - Ge)) * P && (d = 0.9999)),
                  d !== p && Ce.enabled)
                ) {
                  if (
                    ...
                    a &&
                      ...
                      ve && ((o = (!s && "none" !== we[i + 1] && we[i + 1]) || we[i]), (c = O && ("complete" === o || "reset" === o || o in O)))),
                    ge &&
                      (s || c) &&
                      (c || E || !O) &&
                      (Ta(ge)
                    ...
                    a && !Ke
                      ? (ve &&
                        ...
                        pe &&
                          ...
                          (Wa(Ce.callbackAnimation), ee ? ee.progress(1) : Wa(O, "reverse" === o ? 1 : !d, 1)))
                      : ve && C && !Ke && C(Ce);
                }
                if (x) {
  ...
  function wc(e) {
    ...
    if (!a._isScrollT || 2e3 < s - a._isScrollT) {
      for (
        ;
        o && o !== Je && ((o.scrollHeight <= o.clientHeight && o.scrollWidth <= o.clientWidth) || (!oe[(t = mb(o)).overflowY] && !oe[t.overflowX]));
