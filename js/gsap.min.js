...
!(function (t, e) {
    ...
    return (
      ...
      function (t, e, r) {
        ...
        if (!c) {
          ...
          for (
            c = y[d] = [], i = T ? Math.min(f, d) * w - 0.5 : m % f, n = f === U ? 0 : T ? (d * x) / f - 0.5 : (m / f) | 0, l = U, u = h = 0;
            u < d;
            u++
          )
            (a = (u % f) - i),
          ...
          "random" === m && db(c),
            ...
            (c.min = l),
            (c.v = d =
              (parseFloat(p.amount) || parseFloat(p.each) * (d < f ? d - 1 : b ? ("y" === b ? d / f : f) : Math.max(f, d / f)) || 0) *
              ("edges" === m ? -1 : 1)),
            (c.b = d < 0 ? g - d : g),
  ...
  function zb(t, e, r) {
    return (
      ((6 * (t += t < 0 ? 1 : 1 < t ? -1 : 0) < 1 ? e + (r - e) * t * 6 : t < 0.5 ? r : 3 * t < 2 ? e + (r - e) * (2 / 3 - t) * 6 : e) * St + 0.5) | 0
    );
  }
  function Ab(e, r, i) {
    var n,
    ...
    if (!p) {
      if (("," === e.substr(-1) && (e = e.substr(0, e.length - 1)), zt[e])) p = zt[e];
        ...
        if (
          (e.length < 6 &&
            (e = "#" + (n = e.charAt(1)) + n + (a = e.charAt(2)) + a + (s = e.charAt(3)) + s + (5 === e.length ? e.charAt(4) + e.charAt(4) : "")),
          9 === e.length)
        )
  ...
  var F,
    ...
    Ct = function _callback(t, e, r) {
      ...
      if (o)
        return (
          (i = s[e + "Params"]), (n = s.callbackScope || t), r && dt.length && ma(), h && (l = h), (a = i ? o.apply(n, i) : o.call(n)), (l = u), a
        );
    },
    At = [],
    St = 255,
  ...
  var qt,
    ...
    Ut =
      ...
      (qt.time = function time(t, e) {
        return arguments.length
          ? this.totalTime(Math.min(this.totalDuration(), t + Ea(this)) % (this._dur + this._rDelay) || (t ? this._dur : 0), e)
          : this._time;
      }),
    ...
    return (
          ...
          if (_ <= i && 0 <= t)
            for (n = this._first; n; ) {
              if (((a = n._next), (n._act || i >= n._start) && n._ts && h !== n)) {
                ...
                if (
                  (n.render(0 < n._ts ? (i - n._start) * n._ts : (n._dirty ? n.totalDuration() : n._tDur) + (i - n._start) * n._ts, e, r),
            ...
            for (var w = t < 0 ? t : i; n; ) {
              if (((a = n._prev), (n._act || w <= n._end) && n._ts && h !== n)) {
                ...
                if (
                  (n.render(
                    0 < n._ts ? (w - n._start) * n._ts : (n._dirty ? n.totalDuration() : n._tDur) + (w - n._start) * n._ts,
                    e,
      ...
      (e.getTweensOf = function getTweensOf(e, r) {
        for (var i, n = [], a = Mt(e), s = this._first, o = t(r); s; )
          s instanceof $t
            ? la(s._targets, a) &&
              (o ? (!Nt || (s._initted && s._ts)) && s.globalTime(0) <= r && s.globalTime(s.totalDuration()) > r : !r || s.isActive()) &&
              n.push(s)
  ...
  var Nt,
    ...
    Wt = function _addPropTween(t, e, i, n, a, o, u, h, l, f) {
      ...
      var d,
        ...
        _ = s(c) ? (l ? re : te) : Zt;
      if (
        (r(n) && (~n.indexOf("random(") && (n = ob(n)), "=" === n.charAt(1) && ((!(d = ka(p, n) + (Ya(p) || 0)) && 0 !== d) || (n = d))),
        !f || p !== n || Gt)
      )
        return isNaN(p * n) || "" === n
          ? (c || e in t || Q(e, n),
  ...
  var $t = (function (D) {
    function Tween(e, r, i, n) {
      ...
      if (
        ((a._targets = C.length ? ea(C) : R("GSAP target " + e + " not found. https://gsap.com", !q.nullTargetWarn) || []),
        (a._ptLookup = []),
        (a._overwrite = b),
        x || T || y(_) || y(m))
      ) {
    ...
    return (
            ...
            (l && l.render(t < 0 ? t : l._dur * l._ease(i / this._dur), e, r)) || (this._startAt && (this._zTime = t)),
              ...
              (m !== this._tDur && m) ||
                ...
                e ||
                  (_ && !d) ||
                  !(m || d || u) ||
                  (Ct(this, m === c ? "onComplete" : "onReverseComplete", !0), !this._prom || (m < c && 0 < this.timeScale()) || this._prom()));
          }
        } else
      ...
      (e.kill = function kill(t, e) {
        if ((void 0 === e && (e = "all"), !(t || (e && "all" !== e))))
          return (this._lazy = this._pt = 0), this.parent ? tb(this) : this.scrollTrigger && this.scrollTrigger.kill(!!L), this;
        if (this.timeline) {
      ...
      (((Ce = MatchMedia.prototype).add = function add(t, e, r) {
        ...
        for (n in (l && !s.selector && (s.selector = l.selector), this.contexts.push(s), (e = s.add("onMatch", e)), (s.queries = t)))
          "all" === n
            ? (a = 1)
            : (i = h.matchMedia(t[n])) &&
              (ge.indexOf(s) < 0 && ge.push(s), (o[n] = i.matches) && (a = 1), i.addListener ? i.addListener(Fc) : i.addEventListener("change", Fc));
        return (
          a &&
            e(s, function (t) {
              return s.add(null, t);
      ...
      init: function init(t, n, e) {
        e._onInit = function (t) {
          ...
          !(function _addModifiers(t, e) {
            ...
            for (r in e)
              for (i = a.length; i--; )
                (n = (n = t._ptLookup[i][r]) && n.d) && (n._pt && (n = Jc(n, r)), n && n.modifier && n.modifier(e[r], t, a[i], r));
          })(t, n);
        };
      },
    };
  ...
  function Ld() {
    ...
    if (this.tfm) {
      ...
      a.svg && (a.renderTransform(), i.setAttribute("data-svg-origin", this.svgo || "")),
        ((t = Ye()) && t.isStart) ||
          n[cr] ||
          (Kd(n), a.zOrigin && n[pr] && ((n[pr] += " " + a.zOrigin + "px"), (a.zOrigin = 0), a.renderTransform()), (a.uncache = 1));
    }
  }
  function Md(t, e) {
    var r = {
  ...
  var Ee,
    ...
    kr = function _parseTransform(t, e) {
      ...
      return (
        ...
        m !== wr &&
          ...
          6 === m.length
            ...
            : ((R = m[6]),
              ...
              (l = (g = ur(-w, z)) * sr),
              g &&
                ((v = Math.cos(-g)), (D = x * (y = Math.sin(-g)) + D * v), (T = M = T * v - A * y), (b = P = b * v - S * y), (w = C = w * v - z * y)),
              (u = (g = ur(b, T)) * sr),
              g &&
        ...
        90 < Math.abs(f) &&
          Math.abs(f) < 270 &&
          (L ? ((s *= -1), (f += u <= 0 ? 180 : -180), (u += u <= 0 ? 180 : -180)) : ((o *= -1), (f += f <= 0 ? 180 : -180))),
        (e = e || r.uncache),
        (r.x =
          i -
